...
# Project:  test1.pro
# Template: app
# Command: C:\Qt\Qt5.5.1\5.5\mingw492_32\bin\qmake.exe -spec win32-g++ -o Makefile test1.pro
#############################################################################
...
Makefile: test1.pro C:/Qt/Qt5.5.1/5.5/mingw492_32/mkspecs/win32-g++/qmake.conf C:/Qt/Qt5.5.1/5.5/mingw492_32/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec win32-g++ -o Makefile test1.pro
